...
export function BrandsPage() {
  return <main className="brands-page">
    ...
    <BrandsDirectory />
    <section className="brands-page__seo"><h2>Выбор производителя</h2><p>Используйте поиск, направления и алфавит, чтобы быстро найти нужного производителя. Для Remeza доступна согласованная демонстрационная страница; остальные карточки остаются информационными.</p></section>
  </main>
}
