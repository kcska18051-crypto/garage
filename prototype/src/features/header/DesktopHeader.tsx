  ...
  return (
    <div className={`desktop-header${compact ? ' desktop-header--compact' : ''}`}>
      ...
      <div className="main-header-row">
        ...
        <div className="header-actions"><ActionLink to="/profile" label="Профиль" symbol="○" />{!compact && <><ActionLink to="/compare" label="Сравнение" symbol="≡" count={counts.compare} /><ActionLink to="/favorites" label="Избранное" symbol="♡" count={counts.favorites} /></>}<ActionLink to="/cart" label="Корзина" symbol="▱" count={counts.cart} /></div>
      </div>
