...
export const productDetail = {
  ...
  labels: ['Хит', 'Новинка', 'Акция', 'Официальная гарантия'],
  oldPrice: 207200,
  price: 185000,
  gallery: ['Общий вид', 'Панель управления', 'Компрессорный блок', 'Габаритная схема', 'Видео о товаре'],
  keySpecs: [
    ['Производительность', '10 л/мин'], ['Напряжение', '380 В'], ['Максимальное давление', '10 бар'],
    ['Мощность двигателя', '7,5 кВт'], ['Объём ресивера', 'Без ресивера'],
